...
type TxOutput struct {
	...
	PubKeys []PublicKey `protobuf:"bytes,4,rep,name=PubKeys,casttype=PublicKey" json:"PubKeys,omitempty"`
	// Defines the 'verification' logic using TxnInput.Signature as data.  This
	// is run as a check along with the public key match
	Logic []byte `protobuf:"bytes,5,opt,name=Logic,proto3" json:"Logic,omitempty"`
}
...
func (m *TxOutput) GetCounter() int64 {
	if m != nil {
		return m.Counter
	}
	return 0
...
var fileDescriptorTypes = []byte{
	...
	,
}
